...
?>    
  <div id="page-wrapper">        
 <form role="form" method="post" action="save_sell.php" onsubmit="">
    <?php
  if(isset($errMSG)){
    ?>
    <?php
  ...
  ?> 
    <div class="alert alert-default container" style="">
         <h3 align="center">  ລາຍລະອຽດການສັ່ງຊື້ &nbsp;<span class="fa fa-info"></span></h3>
        </div>
        <!-- added -->
    <td><input class="form-control" type="hidden" name="ProductID" value="<?php echo $ProductID; ?>" /></td>
     <td><input class="form-control" type="hidden" name="Sell_name" value="<?php echo $ProductName; ?>" /></td>
     <!-- Added -->
  ...
  <table class="table table-bordered">  
   ...
   <tr>
      ...
      <td><input class="form-control" type="text" name="ProductPrice" value="<?php echo $ProductPrice; ?>ກີບ" disabled/></td>
    </tr> 
      <tr>
   ...
   <?php
        ...
        while($row = mysqli_fetch_array($sql)) {
          ?>
          <td> 
          <input class="form-control" type="number" placeholder="Quantity" id="Sell_Qty" name="Sell_Qty" value="1" onkeypress="return isNumber(event)" onpaste="return false" required />
        </td>
      </tr>
        <tr>
    ...
    <tr>
      <td colspan="2" align="center">
        <button type="submit" name="Sell_save" class="btn btn-primary">
