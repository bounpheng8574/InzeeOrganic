...
$saveaccount="INSERT INTO customers (CustFirstName, CustLastName, CustSex, CustAddress, CustEmail, CustFace, CustPassword, CustTel, CustWhat, CustBirthdate, Delivery, datecreate) VALUE ('$CustFirstName','$CustLastName', '$CustSex','$CustAddress','$CustEmail', '$CustFace', '$CustPassword', '$CustTel', '$CustWhat', '$CustBirthdate','ຍັງ', NOW())";
