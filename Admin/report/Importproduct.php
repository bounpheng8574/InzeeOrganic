...
<br/>
<div class="text-center"><h3>ລາຍງານການນໍາສິນຄ້າເຂົ້າ</h3></div>
                    ...
                    <div class="table-responsive " id="tableResponsive">
                        <table class="table table-hover">
                            <tr>
                                ...
                                <th style="text-align: center">ຜູ້ສະໜອງ</th>
                                <th style="text-align: center">ວັນທີນຳເຂົ້າ</th>
                            </tr>
                            <tbody id="detail">
...
<script  type="text/javascript">
    ...
    $('#btn1').click(function () {
        ...
        if($('#date1').val() !=""){
            ...
            $.ajax({
                type:'POST',
                 url:'getImportDatafromDatabase.php',
                 data : 'date1='+ date1,
                  dataType : 'html',
    ...
    $('#btn2').click(function () {
        if($('#date2').val() !="" && $('#date3').val() !=""){
            ...
            $.ajax({
                type:'POST',
                 url:'getImportDatafromDatabase2.php',
