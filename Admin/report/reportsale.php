...
<div class="text-center"><h3>ລາຍງານການຂາຍສິນຄ້າ</h3></div>
    ...
    <div class="row" style="margin-top: 2%; margin-left: 2%; margin-right: 2%">
        <div class="col-sm-12 my-4" style="box-shadow: 1px 1px 1px 1px #1c7430; height: auto ; background-color: white" id="rightSide">
            ...
            <div style="margin-top: 2%">
                ...
                <div style="margin-top: 2%; display: none;" id="showcontent2">
                        ...
                        <table class="table table-hover">
                            <tr>
                               <th style="text-align: center">ລະຫັດສິນຄ້າ</th>
                                ...
                                <th style="text-align: center">ປະເພດສິນຄ້າ</th>
                                <th style="text-align: center">ລາຄາ/ຫົວໜ່ວຍ</th>
                                <th style="text-align: center">ຈຳນວນ</th>
                                <th style="text-align: center">ວັນທີສັ່ງຈອງ</th>
                            </tr>
                            <tbody id="detail2">
                            </tbody>
                        </table>
                    ...
                    <div style="margin-top: 2%; margin-right: 5%; text-align: right">
                        <button class="btn btn-success" id="windowprint2" onclick="printPage2()"><span class="fa fa-print">  ລາຍງານ </span></button>
                        <p>&nbsp;</p>
                    </div>
                </div>
            </div>
