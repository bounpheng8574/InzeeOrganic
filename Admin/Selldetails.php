...
<!-- table selldetails -->
			<div id="page-wrapper">         				 
			<div class="">
   <center> <h3><strong>ລາຍລະອຽດການຈອງຂອງລູກຄ້າ</strong> </h3>
   </center>
			</div> <br />
		 <div class="table-responsive">
            <table class="display table table-bordered" id="example" cellspacing="0" width="100%">
			  ...
			  <?php
include("../config.php");
	$stmt = $DB_con->prepare('SELECT SellID, Sell_date,customers.CustFirstName, customers.CustLastName, Sell_name, Sell_Price, Sell_Qty, Sell_total, ProductID, Sell_Unit, Sell_Cat from sellproduct, customers WHERE sellproduct.CustID=customers.CustID and Sell_status="Ordered" ORDER BY Sell_date desc');
	$stmt->execute();
